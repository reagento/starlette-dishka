...
![PyPI downloads](https://shieldcn.dev/pypi/dm/starlette-dishka.svg?variant=branded&size=xs&logo=python&logoColor=ffffff)
...
![PyPI licence](https://shieldcn.dev/badge/dynamic/json.svg?url=https%3A%2F%2Fpypi.org%2Fpypi%2Fstarlette-dishka%2Fjson&query=%24.info.license_expression&variant=branded&size=xs&mode=light&logo=python&logoColor=ffffff&label=license)

<a href="https://github.com/reagento/starlette-dishka/actions?query=branch%3Amain"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/github/ci/reagento/starlette-dishka.svg?variant=outline&font=geist-mono&size=xs&animate=pulse&logo=github&mode=dark"><img alt="CI" src="https://shieldcn.dev/github/ci/reagento/starlette-dishka.svg?variant=outline&font=geist-mono&size=xs&animate=pulse&logo=github&mode=light"></picture></a>
<a href="https://github.com/reagento/starlette-dishka/commits/main"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/github/last-commit/reagento/starlette-dishka.svg?variant=outline&font=geist&size=xs&logo=github&mode=dark"><img alt="Last Commit" src="https://shieldcn.dev/github/last-commit/reagento/starlette-dishka.svg?variant=outline&font=geist&size=xs&mode=light&theme=zinc&logo=github"></picture></a>
<a href="https://t.me/reagento_ru"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/badge/dynamic/json.svg?url=https%3A%2F%2Ftg.chirizxc.workers.dev%2Freagento_ru&query=%24.members&suffix=+members&variant=outline&size=xs&mode=dark&logo=ri%3AFaTelegramPlane&logoColor=24A1DE&label=t.me/reagento_ru"/><img alt="Telegram members" src="https://shieldcn.dev/badge/dynamic/json.svg?url=https%3A%2F%2Ftg.chirizxc.workers.dev%2Freagento_ru&query=%24.members&suffix=+members&variant=outline&size=xs&mode=light&logo=ri%3AFaTelegramPlane&logoColor=24A1DE&label=t.me/reagento_ru"/></picture></a>
...
```bash
uv pip install starlette-dishka
```
